...
#define MAX_RX_QUEUE_PER_LCORE 128
...
// static struct rte_eth_conf port_conf = {
//     .rxmode = {
//         .mq_mode = ETH_MQ_RX_RSS,             // Enable Receive Side Scaling (RSS)
//         .max_rx_pkt_len = RTE_ETHER_MAX_LEN,  // Maximum RX packet length
//         .split_hdr_size = 0,                  // Disable split header size
//         .offloads = DEV_RX_OFFLOAD_CHECKSUM,  // Enable RX checksum offloading
//     },
//     .txmode = {
//         //.mq_mode = ETH_MQ_TX_NONE,            // Single queue mode for transmission
//         // .offloads = DEV_TX_OFFLOAD_IPV4_CKSUM | // Enable IPv4 checksum offloading
//         //             DEV_TX_OFFLOAD_UDP_CKSUM |  // Enable UDP checksum offloading
//         //             DEV_TX_OFFLOAD_TCP_CKSUM |  // Enable TCP checksum offloading
//         //             DEV_TX_OFFLOAD_MBUF_FAST_FREE // Enable fast free of mbufs
//     },
//     .rx_adv_conf = {
//         .rss_conf = {
...
//     },
//     .fdir_conf = {
//         .mode = RTE_FDIR_MODE_NONE,           // Disable Flow Director mode
//     },
//     .intr_conf = {
//         .lsc = 1,                             // Enable Link Status Change (LSC) interrupts
//     }
// };
...
//     int assigned_lcores = 0;
//     int primary_lcore_id = rx_lcore_id;
//     int secondary_lcore_id = rx_lcore_id + 1;

//     while (assigned_lcores < 2) {
...
//     /* Reset rx_lcore_id for the next port's primary and secondary lcores */
//     rx_lcore_id = secondary_lcore_id + 1;

//     if (nb_lcores < rx_lcore_id)
//         nb_lcores = rx_lcore_id;
// }
