...
register <bit<16>>(1) myh1;
register <bit<16>>(1) myh2;
...
//////////////////////////////////////////////////////////////////////////////////////////
        ...
        action dl_cloning_0(){
            clone3(CloneType.I2E, 0,standard_metadata.ingress_port);
        }
        action dl_cloning_1(){
            clone3(CloneType.I2E, 1,standard_metadata.ingress_port);
        }
...
//////////////////////////////////////////////////////////////////////////////////////////
        ...
        apply {
                if (standard_metadata.ingress_port > 8){
                        ...
                        hdr.eth.smac= (bit<48>) 0x112233445566;
                        //hdr.eth.dmac=0x66778899aabb;
                        //standard_metadata.egress_spec=5;
                        //myh1.write(0, standard_metadata.ingress_port);
                        standard_metadata.egress_spec= (bit<16>) hdr.buffering.pf_number;
                        //standard_metadata.egress_spec= (bit<16>) 0;
                         // standard_metadata.egress_spec= (bit<16>)(hdr.ipv4.dstAddr%4);
...
control MyEgress(inout ingress_headers_t   hdr,
        ...
        apply {
                  ...
                  // if ( standard_metadata.instance_type== 0x8){
